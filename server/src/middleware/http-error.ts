...
import { ErrorCode, isErrorCode } from '../lib/errors'
 ...
 */
export function resolveErrorCode(err: unknown): ErrorCode | undefined {
  if (err instanceof HttpError) return err.errorCode
  if (
    typeof err === 'object' &&
    err !== null &&
    'errorCode' in err &&
    isErrorCode((err as { errorCode: unknown }).errorCode)
  ) {
