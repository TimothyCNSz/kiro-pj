...
import { createAuthMiddleware, adminGuard, } from './auth';
...
const PAYLOAD_EMPLOYEE = { sub: 'user-1', sid: 'sid-ok', role: Role.Employee };
const PAYLOAD_ADMIN = { sub: 'admin-1', sid: 'sid-admin', role: Role.Admin };
