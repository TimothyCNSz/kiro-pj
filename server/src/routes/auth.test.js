...
import { createAuthRouter, REGISTER_OK_MESSAGE, REGISTER_EMAIL_FAILED_MESSAGE, VERIFY_OK_MESSAGE, RESEND_OK_MESSAGE, LOGIN_OK_MESSAGE, } from './auth';
...
class FakeAuthService {
    ...
    loginResult = { token: 'jwt-token', role: Role.Employee };
    loginError = null;
    loggedOut = [];
...
class FakeAccountGateway {
    ...
    async findPendingUserIdByEmail(_email) {
