...
import { AvatarService, DrizzleAvatarRepository, } from '../services/avatar-service';
 ...
 */
export function createMeAvatarRouter(deps) {
    const router = Router();
 ...
 * 构造无副作用（数据库连接惰性建立）。
 */
export function buildDefaultMeAvatarRouter(overrides = {}) {
