...
import { DEFAULT_SESSION_IDLE_MINUTES, DrizzleSessionService, getSessionIdleMinutes, isSessionValid, } from './session-service';
// ---------------------------------------------------------------------------
...
describe('getSessionIdleMinutes', () => {
    ...
    afterEach(() => {
        if (prev === undefined)
            ...
            process.env.SESSION_IDLE_MINUTES = prev;
    });
