 ...
 */
export function containsPhysicalLine(lines: readonly RedemptionLine[]): boolean {
 ...
 */
export function isValidAddress(address: Address | undefined): address is Address {
 ...
 */
export function assertAddressForPhysical(ctx: RedemptionContext): void {
...
export function toStockCheckItems(lines: readonly RedemptionLine[]): StockCheckItem[] {
 ...
 */
export function assertLinesWithinStock(lines: readonly RedemptionLine[]): void {
 ...
 */
export function validateRedemption(ctx: RedemptionContext): void {
 ...
 */
export function buildRedemptionPreValidate(): NonNullable<RedemptionHooks['preValidate']> {
  return (ctx: RedemptionContext): void => {
