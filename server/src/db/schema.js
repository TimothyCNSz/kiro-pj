...
import { boolean, check, integer, jsonb, pgEnum, pgTable, text, timestamp, uniqueIndex, uuid, varchar, } from 'drizzle-orm/pg-core';
import { ACCOUNT_STATUS_VALUES, ORDER_STATUS_VALUES, ORDER_TYPE_VALUES, PRODUCT_STATUS_VALUES, PRODUCT_TYPE_VALUES, ROLE_VALUES, } from '../lib/domain';
// ---------------------------------------------------------------------------
...
const asEnumValues = (values) => values;
